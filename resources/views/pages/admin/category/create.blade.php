                            ...
                            <div class="card-body">
                                <form method="post" action="{{ route('category.store') }}" class="mt-6 space-y-6"
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <input id="photo" name="photo" type="file" class="block w-full mt-1 text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-500 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" accept="image/*" required>
                                        @error('photo')
                                            <p class="text-sm text-red-600 mt-2">{{ $message }}</p>
                                        @enderror
                                    </div>
