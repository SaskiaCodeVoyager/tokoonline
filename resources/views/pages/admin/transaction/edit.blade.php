                    ...
                    <div class="bg-white rounded-lg shadow-md">
                        <div class="p-4">
                            ...
                            <select id="transaction_status" name="transaction_status"
                                ...
                                <option value="pending" @if (old('transaction_status', $transaction->transaction_status) == 'pending') selected @endif>Pending
                                </option>
                                <option value="completed" @if (old('transaction_status', $transaction->transaction_status) == 'completed') selected @endif>Completed
                                </option>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                            ...
                                            <tbody>
                                                @foreach ($itemDetails as $key => $itemDetail)
                                                    <tr>
                                                        <td>{{ $key + 1 }}</td>
                                                        <th scope="row">
                                                            <div class="d-flex align-transaction-center">
                                    ...
                                    <div class="flex transaction-center gap-4">
                                        <a class="inline-flex transaction-center px-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-500 rounded-md font-semibold text-xs text-gray-700 dark:text-gray-300 uppercase tracking-widest shadow-sm hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 disabled:opacity-25 transition ease-in-out duration-150"
