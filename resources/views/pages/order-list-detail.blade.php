...
@section('title')
    Order List Detail | Merchandise Anime
@endsection

@section('content')
    <!-- Single Page Header start -->
    <div class="py-5 container-fluid page-header" style="background-image: url('{{ asset('img/image.png') }}');">
        <h1 class="text-center display-6" style="color: white;">Order list detail</h1>
<ol class="mb-0 breadcrumb justify-content-center">
    ...
    <li class="breadcrumb-item active" style="color: white;">Order list detail</li>
</ol>
