            ...
            <div class="m-3 d-flex me-0">
                ...
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                        <img src="{{ Auth::user()->photo ? asset('storage/' . Auth::user()->photo) : asset('default-profile.png') }}" alt="Profile Photo" class="rounded-circle" style="width: 40px; height: 40px; margin-left: 8px;">
                    </a>
